function createTable() {
	...
	document.getElementById('func').children[1].innerHTML += '<input type="button" onclick="createHeader()" value="Add a header">';
...
function createHeader() {
	document.getElementById('table').innerHTML += '<caption>My first dynamic table!</caption>';
}
