...
document.write('<a href="https://www.youtube.com/watch?v=6Dh-RL__uN4" id="">Random youtube song btw.</a><br>')

document.write('<img src="gtfo.jpg" style="width: 30%; height: 50%" id="pic1">')
document.write('<img src="logo.jpg" style="width: 50%; height: 10%" id="pic2"><br>')
...
for(i=0; i<10; i++){
  ...
  document.write('<input type="button" class="dvosh" value="Hi" onClick="alert(\'Form_name\')"></input>')
...
document.write('<form id="form1"><input type="reset" value="RESET"></input><input type="text" placeholder="Write anything to reset"></input></form>')
document.write('<form id="form2"><input type="button" id="butt"></input><input type="password" placeholder="cant see"></input></form>')
for(i=0; i<10; i++){
    if(i % 2 != 0){
